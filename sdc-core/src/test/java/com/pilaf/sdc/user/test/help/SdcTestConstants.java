...
public interface SdcTestConstants {
    ...
    public static final String MAIL_NAME_RECIPENT_1 = "example@ex.pl";
    public static final String MAIL_TITLE = "example@ex.pl";
    public static final ContactDO CONTACT_1 = new ContactDO(PHONE_NR_1, MAIL_NAME_RECIPENT_1);
